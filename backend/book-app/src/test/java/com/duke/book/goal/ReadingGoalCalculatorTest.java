...
package com.duke.book.goal;

import static com.duke.book.goal.ReadingGoalCalculator.calculateProgressTowardsReadingGoal;
import static com.duke.book.goal.ReadingGoalCalculator.howFarAheadOrBehindSchedule;
import static com.duke.book.goal.ReadingGoalCalculator.booksToReadFromStartOfYear;

import com.duke.book.book.model.Author;
import com.duke.book.book.model.Book;
import com.duke.book.util.DateUtils;
...
class ReadingGoalCalculatorTest {
  ...
  void shouldNotThrowExceptionOnZeroDivision() {
    ...
    assertSoftly(
        softly -> {
          softly
              .assertThatCode(() -> calculateProgressTowardsReadingGoal(toRead, read))
  ...
  void returnFalseIfBookNotReadThisYear() {
    ...
    Book book = createBook().dateFinishedReading(lastYear).build();
  ...
  void returnTrueIfBookReadThisYear() {
    ...
    Book book = createBook().dateFinishedReading(currentDate).build();
